...
"C:\Program Files\7-Zip\7z.exe" a -tzip "..\_webservice\upd\update-package2.zip" -p3aTaTre6agA$-E+e "D:\sync\private\Projects\AxTools\AxTools_x64\bin\x64\Release\distr2\*" -r -mx9
_makeRelease2_update-file-version.py
py "D:\sync\private\Projects\AxTools\AxTools_x64\_makeRelease2_plugins.py"
