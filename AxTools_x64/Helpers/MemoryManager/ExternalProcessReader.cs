...
using AxTools.Helpers.MemoryManager.Native;
using MemoryAllocationType = AxTools.Helpers.MemoryManager.Native.MemoryAllocationType;
using MemoryFreeType = AxTools.Helpers.MemoryManager.Native.MemoryFreeType;
using MemoryProtectionType = AxTools.Helpers.MemoryManager.Native.MemoryProtectionType;

namespace AxTools.Helpers.MemoryManager
{
    public sealed unsafe class ProcessReader : MemoryBase
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ProcessReader" /> class.
        /// </summary>
        /// <param name="proc">The proc.</param>
        /// <remarks>Created 2012-04-24</remarks>
        public ProcessReader(Process proc) : base(proc)
        {
            if (IsProcessOpen)
            {
        ...
        public new void ReadUnsafe(IntPtr address, void* buffer, int count)
        {
        ...
        /// <returns> . </returns>
        public AllocatedMemory CreateAllocatedMemory(int numBytes)
        {
