...
namespace AxTools.WoW.Management.ObjectManager
{
    ...
    internal struct PlayerInventoryAndContainers
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 19)] internal UInt128[] InvSlots;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] internal UInt128[] Containers;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)] internal UInt128[] Backpack;
