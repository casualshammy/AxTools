    ...
    internal class Program
    {
        private static void Main()
        {
            ...
            Pattern[] patterns =
            {
                ...
                Pattern.FromTextstyle("FocusedWidget", "48 39 0D ?? ?? ?? ?? 75 ?? 48 C7 05 ?? ?? ?? ?? 00 00 00 00 48 8B 01 45 0F B6 C8 44 0F B6 C2 33 D2 48 FF A0 E8 01 00 00", new AddModifier(3), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("BlackMarketNumItems", "44 8B 0D ?? ?? ?? ?? 45 33 C0 45 8B D1 41 8B C0 45 85 C9 74 ?? 4C 8B 1D ?? ?? ?? ?? 49 8D 8B A0 00 00 00 0F 1F 40 00", new AddModifier(3), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("BlackMarketItems", "44 8B 0D ?? ?? ?? ?? 45 33 C0 45 8B D1 41 8B C0 45 85 C9 74 ?? 4C 8B 1D ?? ?? ?? ?? 49 8D 8B A0 00 00 00 0F 1F 40 00", new AddModifier(24), new LeaModifier(LeaType.CmpMinusOne)),
                ...
                Pattern.FromTextstyle("PlayerZoneID", "8B 15 ?? ?? ?? ?? 4C 8D 05 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? 45 33 C9 44 89 64 24 28 4C 89 64 24 20 E8 ?? ?? ?? ?? 4C 8B F0", new AddModifier(2), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("PlayerPtr", "48 89 BC 24 C0 00 00 00 48 8B 3D ?? ?? ?? ?? 48 85 FF 75 ?? 48 8D 4D E7 E8 ?? ?? ?? ?? 4C 8D 05 ?? ?? ?? ?? 8D 57 10 48 8D 4D E7", new AddModifier(11), new LeaModifier(LeaType.CmpMinusOne)),
                ...
                Pattern.FromTextstyle("KnownSpellsCount", "E8 ?? ?? ?? ?? 8B D8 85 C0 0F 84 ?? ?? ?? ?? 44 8B 05 ?? ?? ?? ?? 8B CF 45 85 C0 74 ?? 48 8B 15 ?? ?? ?? ?? 66 90", new AddModifier(18), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("KnownSpells", "E8 ?? ?? ?? ?? 8B D8 85 C0 0F 84 ?? ?? ?? ?? 44 8B 05 ?? ?? ?? ?? 8B CF 45 85 C0 74 ?? 48 8B 15 ?? ?? ?? ?? 66 90", new AddModifier(32), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("ZoneText", "48 8D 1C 08 EB ?? 48 8B 1D ?? ?? ?? ?? 48 8B D3 48 8B CF E8 ?? ?? ?? ?? 48 8B 5C 24 50", new AddModifier(9), new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("ChatBuffer", "C6 85 C8 2C 00 00 01 E8 ?? ?? ?? ?? 44 8B 3D ?? ?? ?? ?? 41 83 CE FF 33 FF 4C 8D 2D ?? ?? ?? ?? F2 48 0F 2C C0", new AddModifier(28), new LeaModifier(LeaType.CmpMinusOne)),
