            ...
            while (counter > 0)
            {
                try
                {
                    ...
                    if (process.MainWindowHandle != (IntPtr)0)
                    {
                        ...
                        {
                            GlueState glueState = wowProcess.Memory.Read<GlueState>((IntPtr)WowBuildInfo.GlueState, true);
                            IntPtr focusedWidget = wowProcess.Memory.Read<IntPtr>((IntPtr)WowBuildInfo.FocusedWidget, true);
